...
type NodeComponentPropsType = {
    ...
    personData?: DataTreeResponseType
}

function NewNode(props?: NodeComponentPropsType) {
    return <li>
        <a>
            <div className="member-view-box">
                <div className="member-image">
                    ...
                    <div className="member-details">
                        <h3>{props?.personData?.firstName} {props?.personData?.lastName}</h3>
                    </div>
                </div>
            </div>
        </a>
